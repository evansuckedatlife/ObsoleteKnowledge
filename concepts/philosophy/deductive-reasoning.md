...
**Deductive reasoning**, also termed **deduction** or **deductive logic**, is the process of reasoning from one or more general statements or premises to reach a logically certain conclusion. In the history of western *[[philosophy]]*, it represents the highest ideal of formal demonstration, guaranteeing that if the initial premises are true, the conclusion must inevitably be true as well. Formalised in *[[ancient-greece]]* through the syllogisms of *[[aristotle]]*, deduction forms the foundational architecture of mathematics, formal *[[logic]]*, and axiomatic epistemology.

## you gotta know

- Evaluated fundamentally by two criteria: *validity*, which refers to whether the structural form ensures the truth of the conclusion given true premises, and *soundness*, which requires both structural validity and factual truth in the premises.
- Contrasts sharply with *induction*, which aggregates specific empirical observations to infer probabilistic generalisations that can never achieve absolute formal certainty.
- Systematised by *[[aristotle]]* in the *Prior Analytics*, which forms part of his foundational logical corpus, the *Organon*, introducing the categorical *syllogism* with major, minor, and middle terms.
...
- [[logic]] — the formal study of valid inference, argument structures, and truth preservation.
